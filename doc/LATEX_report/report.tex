...
%====================================================================================================================================		
	...
	\section{Student Analysis}\label{sec:analysis}
		\subsection{As of April 25, 2016}
			\begin{itemize}
				\item {\bfseries Brendan Lowe}: The Raspberry Pi's have been running for a few weeks. A couple bug have been noted with the TempLog.py and 														readings below 10 degrees C. We were able to remedy the issue and upload new code to the installed Raspberry 
												Pi without the need for physical access.
			...
			\subsection{As of May 8, 2016}
				\begin{itemize}
					\item {\bfseries Brendan Lowe}: The devices have been in the field for about a month and they have been consistently phoning home 	 															information to the Lamp Server. The interaction between the Raspberry Pi and the Lamp Server dominated the 													pre-deployment work that I did. Since the deployment, the focus of my development shifted. I began to try 
													to polish the Raspberry Pi's interface to make it more user friendly and more of a finished product.
